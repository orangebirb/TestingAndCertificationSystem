...
namespace TestingAndCertificationSystem.Controllers
{
    ...
    public class TestsController : Controller
    {
        ...
        #region test management
            ...
            #region Tests (list of tests in company depending on user's role)
            ...
            public async Task<IActionResult> EditTest(Test test)
            {
                ...
                try
                {
                    var additionalTaskId = testToEdit.AdditionalTaskId;
                    test.AdditionalTaskId = additionalTaskId;
                ...
                {
                    ModelState.AddModelError("", "An error occurred while updating the test data");
                }
                finally
                {
                    TempData["testId"] = testToEdit.Id;
            ...
            #region Activate or deactivate test
            ...
            #region Test infopage

            [Authorize(Roles = Roles.CompanyAdmin + ", " + Roles.CompanyModerator)]
            public async Task<IActionResult> TestInfopageAsync(int testId)
            {
                UserIdentity currentUser = await _userManager.GetUserAsync(User);
        ...
        #region additional task management
            ...
            public async Task<IActionResult> EditAdditionalTask(AdditionalTask additionalTask)
            {
                ...
                {
                    ModelState.AddModelError("", "An error occurred while updating the additional task data");
                }
                finally
                {
                    TempData["testId"] = _context.Test.Where(x => x.AdditionalTaskId == taskToEdit.Id).FirstOrDefault().Id;
        ...
        #region test privacy settings
            ...
            #region Verified users

            [Authorize(Roles = Roles.CompanyAdmin + ", " + Roles.CompanyModerator)]
            public async Task<IActionResult> VerifiedUsers(int testId, int page = 1)
            {
                int pageSize = 10;
            ...
            #region Add user to verified list
            ...
            #region Remove user from verified list
